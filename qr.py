...
class QRCodeApp:
    def __init__(self, root):
        ...
        self.spinner_img = ImageTk.PhotoImage(Image.open("assets/spinner.gif"))
    ...
    def setup_ui(self):
        ...
        # Center the spinner on the canvas (this line places the spinner in the center)
        self.spinner_label = tk.Label(self.root, image=self.spinner_img)
    ...
    def animated_click(self, command):
        self.show_spinner(True)  # Show spinner
        self.root.after(0, lambda: command())  # Run the command after 0 ms
        self.root.after(300, self.show_spinner, False)  # Hide spinner after 300 ms (adjust for your needs)

    def show_spinner(self, show):
        if show:
            self.spinner_label.place(relx=0.5, rely=0.5, anchor="center")
        else:
            self.spinner_label.place_forget()  # Hide spinner
